...
- 🐛 **Segnalazione bug** — Hai trovato un problema? [Apri una issue](https://github.com/AndreaBonn/life-tracker/issues/new)
- 💡 **Richieste funzionalità** — Hai un'idea? [Suggerisci una nuova funzionalità](https://github.com/AndreaBonn/life-tracker/issues/new)
- 📖 **Documentazione** — Qualcosa non è chiaro? [Richiedi miglioramenti](https://github.com/AndreaBonn/life-tracker/issues/new)
...
[![Star su GitHub](https://img.shields.io/github/stars/AndreaBonn/life-tracker?style=social)](https://github.com/AndreaBonn/life-tracker)
...
```markdown
**Descrizione:**
Quando provo ad aggiungere un nuovo peso, il pulsante salva non funziona.

**Passaggi per riprodurre:**
1. Vai alla tab "Peso Corporeo"
2. Inserisci il valore del peso (es. 75.5)
3. Clicca "Salva"
4. Non succede nulla
...
```markdown
**Funzionalità:** Esportazione dati in PDF

**Caso d'uso:**
Voglio condividere i miei progressi di salute con il mio medico, ma i file CSV non sono facili da leggere. Un'esportazione PDF con grafici sarebbe perfetta.

**Come funzionerebbe:**
- Aggiungere un pulsante "Esporta in PDF" accanto a "Esporta CSV"
- Generare un PDF con:
  - Riepilogo del periodo selezionato
  - Grafici per ogni metrica
  - Tabella con dati dettagliati
...
- GitHub Discussions (in arrivo)
- Social media con hashtag `#LifeTrackerByBonn`
- Messaggio diretto tramite profilo GitHub
...
1. **Fai un fork di questo repository** (per modifiche alla documentazione)
...
- [ ] Temi personalizzati
- [ ] Condivisione dati con operatori sanitari
- [ ] Analisi avanzate e insights AI
- [ ] Pianificazione pasti con ricette
- [ ] Funzionalità social (amici, sfide)
- [ ] Integrazione dispositivi indossabili (Fitbit, Garmin, ecc.)

**Vuoi votare?** Apri una issue o contattami!
